...
tmux send-keys "sudo docker exec -it ros-px4-humble /bin/bash -c \"cd $(pwd)/ws/src/fase_1/fase_1; source /opt/ros/humble/setup.bash; source ../../../install/setup.bash; python3 imagem.py\"" C-m
